        ...
        <el-col :span="24">
          <el-menu
            ...
            <el-submenu index="2">
              ...
              <el-menu-item-group>
                <el-menu-item index="/PeopleVue">人员管理</el-menu-item>
                <el-menu-item index="/DepartmentVue">部门管理</el-menu-item>
                <el-menu-item index="/PemissionVue">权限管理</el-menu-item>
              </el-menu-item-group>
            </el-submenu>
            ...
            <el-submenu index="3">
              ...
              <el-menu-item-group>
                ...
                <el-menu-item index="3-3">市场管理</el-menu-item>
              </el-menu-item-group>
            </el-submenu>
            ...
            <el-submenu index="4">
              ...
              <el-menu-item-group>
                <el-menu-item index="/Propertys">资产管理</el-menu-item>
            ...
            <el-submenu index="5">
              ...
              <el-menu-item-group>
                <el-menu-item index="/Article">物品详情</el-menu-item>
              </el-menu-item-group>
            </el-submenu>
            ...
            <el-submenu index="6">
              ...
              <el-menu-item-group>
                <el-menu-item index="/Meeting">会议信息</el-menu-item>
                <el-menu-item index="/Room">会议室管理</el-menu-item>
              </el-menu-item-group>
            </el-submenu>
            ...
            <el-submenu index="7">
              ...
              <el-menu-item-group>
                <el-menu-item index="/carlist">车辆信息</el-menu-item>
                <el-menu-item index="/sendlist">派车管理</el-menu-item>
                <el-menu-item index="/garagelist">修车管理</el-menu-item>
              </el-menu-item-group>
            </el-submenu>
            ...
            <el-submenu index="8">
              ...
              <el-menu-item-group>
                ...
                <el-menu-item index="/category">考勤类别</el-menu-item>
              </el-menu-item-group>
            </el-submenu>
...
<script>
  export default {
    ...
    created(){
      ...
      this.$router.push("/PeopleVue");
    },
    methods: {

      queryPersonne(){
        var self = this;
        this.$axios.post("/zuulApi/people_management/login/longinPersonnel").then(function (response) {
      ...
      updatepassword(){
        if(this.personnels.password!=null){
          if(this.personnels.password !== this.personnels.checkpassword){
            ...
            this.$axios.post("/zuulApi/people_management/personnel/updatePassword",this.$qs.stringify(this.personnel)).then(function (response) {
