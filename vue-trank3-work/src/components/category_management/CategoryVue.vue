...
<script>
    export default {
        ...
        methods:{
            ...
            addCategory(){
                var self = this
                  this.$axios.post("/zuulApi/attendance/category/addCategory",this.$qs.stringify(this.form)).then(function (res) {
            ...
            toUpdateCategory(id){
                var self = this
                this.$axios.get("/zuulApi/attendance/category/queryCategoryById?id="+id).then(function (res) {
            ...
            updateCategory(){
                ...
                this.updateForm = false
                  this.$axios.post("/zuulApi/attendance/category/updateCategory",this.$qs.stringify(this.uform)).then(function (res) {
            ...
            deleteCategory(id){
                ...
                this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
                    ...
                    this.$axios.get("/zuulApi/attendance/category/deleteCategory?id="+id).then(function (res) {
            ...
            deleteBatchCategory(){
                ...
                if(this.multipleSelection.length > 0){
                    this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
                        ...
                        this.$axios.post("/zuulApi/attendance/category/deleteBatchCategory",this.$qs.stringify({"ids":ids},{indices: false})).then(function (res) {
                            self.$message.success("删除成功")
                            self.queryCategoryList()
                        }).catch(function () {
                            self.$message.error("删除失败")
